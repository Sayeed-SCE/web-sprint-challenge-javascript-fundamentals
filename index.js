...
// it's an example of closure, a closure happens when a function in our 
// inner scope reference a variable in our outer scope. also the nested function is an example of 
// higher oreder function where the nested function located inside the myFunction and it's being called
...
const zooAnimals = [
  ...
  */
  ...
  //   array.map(animal => animal.animal_name.toLowerCase())); 
 ...
 function USApop(array){
  ...
  const total = array.reduce(function(acc, animal){
 ...
 console.log('The total zoo animal population in the USA:', USApop(zooAnimals));
...
function greeting(firstName, lastName){
   ...
   return `Hello ${firstName.toString()}, ${lastName.toString()}, nice to meet you!`;
  }
...
CuboidMaker.prototype.surfaceArea = function(cube){
  ...
  cube = (this.length * this.width + this.length * this.height + this.width * this.height);
  return cube;
